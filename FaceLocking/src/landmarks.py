"""
FaceLock Vision - Landmark Detector
Developed by Paulin | 5-point facial feature extraction via MediaPipe
"""
    ...
    try:
        while True:
            ...
            if results.multi_face_landmarks:
                ...
                cv2.putText(
                    vis, "FaceLock Vision  |  Landmarks detected", (10, 30),
            ...
            cv2.imshow("FaceLock - Landmarks", vis)
