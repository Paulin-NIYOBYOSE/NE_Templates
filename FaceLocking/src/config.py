...
LOCK_CONFIDENCE_MAX_DISTANCE = 0.50  # Maintain lock while distance <= this
LOCK_RELEASE_DISTANCE = 0.55  # Drop lock if distance exceeds this

# ============================================================================
# CAMERA SETTINGS
# ============================================================================

CAMERA_INDEX = 0  # Use python -m src.camera_utils to find the right index (0=external/first, 1=built-in on Mac)
CAMERA_AUTO_DETECT = True  # Fall back to other indices if CAMERA_INDEX fails (prefers external cameras)
...
MQTT_BROKER_HOST = "157.173.101.159"  # Teacher's MQTT broker
...
# FACE BOX COLORS (BGR)
# ----------------------------------------------------------------------------
COLOR_UNKNOWN = (0, 0, 255)     # Red    - Unregistered face
COLOR_KNOWN = (255, 0, 0)       # Blue   - Recognized, not targeted
COLOR_LOCKED = (0, 255, 0)      # Green  - Target locked
COLOR_LOST = (0, 165, 255)      # Orange - Target lost / searching
COLOR_HUD = (0, 255, 0)         # Overlay text
