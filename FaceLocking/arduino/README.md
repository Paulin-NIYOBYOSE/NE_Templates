# FaceLock Vision — ESP8266 Servo Tracker

**Developed by Paulin** | Arduino firmware for MQTT-based camera pan control.
...
See `../README.md` in the project root for the complete setup guide.
