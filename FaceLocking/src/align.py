"""
FaceLock Vision - Face Alignment Engine
Developed by Paulin | 5-point landmark warping to canonical pose
"""
...
def main():
    ...
    if face_cascade.empty():
        print(f"  ✗ Failed to load cascade.")
        return False
    ...
    print("  ● Alignment engine ready")
    print("    [Q]uit  [S]ave crop")
    ...
    try:
        while True:
            ...
            cv2.imshow("FaceLock - Original", vis)
            cv2.imshow("FaceLock - Aligned", aligned_vis)
