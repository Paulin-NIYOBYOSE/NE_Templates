"""
FaceLock Vision - Face Embedding Engine
Developed by Paulin | ArcFace ONNX model for 512-dim face signatures
"""
...
def main():
    ...
    try:
        ...
        print(f"  ✗ {e}")
        print("\n  To download model:")
        print("    curl -L -o models/embedder_arcface.onnx https://github.com/opencv/opencv_zoo/raw/main/models/face_recognition_sface/face_recognition_sface_2021dec.onnx")
        return False
    ...
    try:
        while True:
            ...
            cv2.putText(
                vis, "[Q]uit  [P]rint stats", (10, 470),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, (200, 200, 200), 1
            )
            
            cv2.imshow("FaceLock - Embedding", vis)
